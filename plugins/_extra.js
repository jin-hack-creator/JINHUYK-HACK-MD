...
smd({
  cmdname: "feature",
  alias: ["totalfeature", "features", "jinhuyk"],
  category: "tools",
  react: ['⏳,⌛️'],
  filename: __filename,
...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/jin-hack-creator/JINHUYK-HACK-MD*");
    }
